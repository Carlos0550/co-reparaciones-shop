...
import usePromotionEditor from './PromotionEditorLogic/usePromotionEditor';
                    ...
                    <div>
                        ...
                        <div>
                            {selectedProducts.map(product => (
                                <span key={product} onClick={() => handleRemoveProduct(product)}>
                                    {product} ❌
                                </span>
                            ))}
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            {selectedCategories.map(category => (
                                <span key={category} onClick={() => handleRemoveCategory(category)}>
                                    {category} ❌
                                </span>
                            ))}
                        </div>
